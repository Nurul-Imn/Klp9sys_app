...
@section('page_title', 'Tambah Pet Baru')
        ...
        <form action="{{ route('pets.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" required placeholder="Contoh: Milo" 
                ...
                <div>
                    ...
                    <input type="text" name="breed" id="breed" placeholder="Contoh: Persia, Golden Retriever" 
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="age" id="age" min="0" placeholder="0" 
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="weight" id="weight" step="0.01" min="0" placeholder="0.0" 
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150">
                </div>
            </div>
